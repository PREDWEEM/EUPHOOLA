...
st.set_page_config(page_title="Predicción de Emergencia Agrícola EUPHO - OLAVARRÍA 2025", layout="wide")
...
PRON_DIAS_API = 8  # (no se usa para visualizar; queda por si lo necesitás en otros flujos)
...
# ================== App ==================
st.title("Predicción de Emergencia Agrícola EUPHO - OLAVARRÍA 2025")
...
def procesar_y_mostrar(df: pd.DataFrame, nombre: str):
    ...
    # (Opcional) Reindex diario para continuidad visual (ffill)
