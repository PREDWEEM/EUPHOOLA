...
st.set_page_config(page_title="Predicción de Emergencia Agrícola EUPHO - BORDENAVE 2025", layout="wide")
...
# ================== App ==================
st.title("Predicción de Emergencia Agrícola EUPHO - BORDENAVE 2025")
